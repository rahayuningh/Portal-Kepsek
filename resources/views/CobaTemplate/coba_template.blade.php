...
<div class="row">
  ...
  <div class="col-12 btn btn-group justify-content-center">
    <div class="btn-group" style="width: 100%" role="group" aria-label="Basic example">
      <button class="tab-link btn btn-inverse-info" style="border-color: #cacaca" onclick="openPage('DataSiswaPerTahun', this, '#0000ff')" id="defaultOpen">Tabel per Tahun Ajaran</button>
      <button class="tab-link btn btn-inverse-info" style="border-color: #cacaca" onclick="openPage('DataSiswaPerWilayah', this, '#0000ff')" >Tabel per Wilayah</button>
    </div>
  </div>
